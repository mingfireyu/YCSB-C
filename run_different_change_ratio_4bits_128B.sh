...
dbfilename_o=/home/wujy/"$DISK"_"$value_size"/mlsm
...
zipfianconst=1.10
echo "$dbfilename"
bitsArrayFilename=/home/wujy/work/bitsArray355555.txt
...
do
	...
	do
		...
		echo "zipfian"
		dirname=/home/wujy/experiment/expectation/lsm_"$DISK"_read_"$requestdistribution""$zipfianconst"_multi_filter_sizeRatio"$sizeRatio"/experiment"$experiment_time"_"$value_size"_r/FilterCapacityRatio_"$FilterCapacityRatio"_lru0_1000WRead_initFilterNum"$initFilterNum"_directIO_"$directIOFlag"_blockCacheSize"$blockCacheSize"MB
	    else
		echo "$requestdistribution"
		dirname=/home/wujy/experiment/expectation/lsm_"$DISK"_read_"$requestdistribution"_multi_filter_sizeRatio"$sizeRatio"/experiment"$experiment_time"_"$value_size"_wr/FilterCapacityRatio_"$FilterCapacityRatio"_lru0_1000WRead_initFilterNum"$initFilterNum"_directIO_"$directIOFlag"_blockCacheSize"$blockCacheSize"MB
	    fi
